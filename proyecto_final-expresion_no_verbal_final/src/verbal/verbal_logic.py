# src/verbal/verbal_logic.py (VERSIÓN FINAL MULTILINGÜE)
...
def transcribe_audio(audio_path):
    ...
    # Se usa el modelo 'medium' para mayor precisión en múltiples idiomas.
    logging.info("Cargando modelo de transcripción 'medium' (puede tardar la primera vez)...")
...
def summarize_text(text, language):
    ...
    try:
        ...
        # Lógica de resumen simplificada, efectiva para la mayoría de los modelos.
        summary = summarizer(text, max_length=250, min_length=40, do_sample=False)
...
def clarity_score(text):
    ...
    if not sentences: return 8.0 # Puntuación por defecto si no hay texto
